    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="contractviewApp.provider.home.createOrEditLabel">
              <Translate contentKey="contractviewApp.provider.home.createOrEditLabel">Create or edit a Provider</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
