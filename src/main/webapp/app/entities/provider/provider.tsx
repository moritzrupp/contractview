...
export type IProviderState = IPaginationBaseState;
...
export class Provider extends React.Component<IProviderProps, IProviderState> {
  ...
  render() {
    const { providerList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="provider-heading">
          <Translate contentKey="contractviewApp.provider.home.title">Providers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="contractviewApp.provider.home.createLabel">Create a new Provider</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {providerList && providerList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="contractviewApp.provider.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('website')}>
                    <Translate contentKey="contractviewApp.provider.website">Website</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="contractviewApp.provider.home.notFound">No Providers found</Translate>
            </div>
          )}
        </div>
